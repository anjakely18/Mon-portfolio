...
const ProjectsCard = ({ gallery, title, text, slug, techs }) => {
  return (
    <Link to={`/projects/${slug}`} className="bg-bg-second rounded-lg p-4 flex flex-col gap-3 h-full cursor-pointer hover:shadow-glow transition-all duration-300 group">
